...
\date{For \Rpackage{gnm} version 0.6-2, 2005-07-14}
...
> anova.glm(nullModel, commonTopo, multTopo, separateTopo)
Analysis of Deviance Table

Model 1: Freq ~ country:origin + country:destination
Model 2: Freq ~ Topo(origin, destination, spec = levelMatrix) + 
